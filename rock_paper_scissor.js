...
function getComputerChoice()
{
    ...
    switch (comp_choice) {
        case "rock":    
            changeImage("comp-play","images/rock_right.png");   
            break;
        case "paper":
            changeImage("comp-play","images/paper_right.png");    
            break;
        case "scissor":
            changeImage("comp-play","images/scissor_right.png");
            break;
        default:
            changeImage("comp-play","images/questionmark.png");      
            break;
    }
    return comp_choice   
}
...
function playTurn()
{
    ...
    {
        play('rock');
        changeImage("player-play","images/rock_left.png");
    })

    paper.addEventListener('click', function()
    {
        play('paper');
        changeImage("player-play","images/paper_left.png");
    })
    scissor.addEventListener('click', function()
    {
        play('scissor');
        changeImage("player-play","images/scissor_left.png");
    })
}
